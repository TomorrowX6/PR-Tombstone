// Package vercelapp owns the Vercel-specific application wiring. Keeping this
// package inside the pr-tombstone module allows it to import internal packages
// while api/index.go remains a thin adapter for Vercel's generated handler.
package vercelapp
...
// Handler serves the Vercel Go Runtime adapter in api/index.go.
