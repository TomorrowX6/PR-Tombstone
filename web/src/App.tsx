...
type Match = { id: number; new_pr_number: number; old_pr_number: number; score: number; relationship: string; reason: string };
type Tombstone = {
  id: number;
  repository: Repo;
